...
loc_df_noCvL %>%
  ...
  theme_bw() + 
  scale_fill_brewer(palette = "RdPu") +
  labs(title = "Bandwidth Estimates for Location", x= "", y= "Bandwith Estimate", fill = "Method") +
  theme(plot.title = element_text(hjust = 0.5))
...
data.frame("City" = loc_df$City, "CvL"= loc_df$CvL)  %>%
  ...
  theme_bw()+
  labs(title ="Bandwidth Estimates for Location with CvL method", x = "", y = "Bandwidth Estimate")+
  theme(plot.title = element_text(hjust = 0.5))
```
